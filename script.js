...
const undoButton =
    document.getElementById("undo-round");
...
function reducePoints() {
    ...
    lastRoundSnapshot = {
        ...
        eliminatedPlayers: JSON.parse(JSON.stringify(eliminatedPlayers)),
...
function undoLastRound() {
    ...
    players =
        JSON.parse(
            JSON.stringify(lastRoundSnapshot.players)
        );

    eliminatedPlayers =
        JSON.parse(
            JSON.stringify(lastRoundSnapshot.eliminatedPlayers)
        );

    currentRound =
        lastRoundSnapshot.currentRound;

    roundHistory =
        JSON.parse(
            JSON.stringify(lastRoundSnapshot.roundHistory)
        );

    gameFinished =
        lastRoundSnapshot.gameFinished;

    // ====================================
    // CLEAR SNAPSHOT & DISABLE BUTTON
    // ====================================
...
loadGame();const playerSetup = document.getElementById("player-setup");
const playerNamesInput = document.getElementById("player-names");
const createPlayersButton = document.getElementById("create-players");
